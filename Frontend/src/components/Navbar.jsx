...
function Navbar() {
  ...
  return (
    <>
      <div
        className={`max-w-screen-2xl container mx-auto md:px-20 px-4 fixed dark:bg-slate-900 dark:text-white top-0 z-50 ${
          sticky
        ...
        <div className="navbar  shadow-sm">
          ...
          <div className="navbar-end space-x-3">
            ...
            <div className="hidden md:block">
              <label className="input px-3 py-1 rounded-md border dark:bg-slate-900 dark:text-white">
                <svg
                ...
                <input
                  ...
                  required
                  placeholder="Search"
                  className="outline-none grow dark:bg-slate-900 dark:text-white w-56"
                />
              </label>
            </div>
            <div>
